...
* The only required non-python program is [samtools](http://www.htslib.org) (versions: 1.16.1, 1.21 and 1.22).
* IgCaller has been validated exclusively on BAM files aligned with [BWA-MEM](http://bio-bwa.sourceforge.net/) (versions: 0.7.15 and 0.7.17).
